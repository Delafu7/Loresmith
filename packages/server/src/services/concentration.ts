...
// forces a Constitution saving throw, DC = max(10, floor(damage / 2)); a
// failed save ends concentration. This module only computes the DC and
// finds the effect a check would apply to — the actual save roll reuses
