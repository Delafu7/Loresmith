...
export const notes = {
  ...
  titleLabel: 'Title',
  bodyLabel: 'Body',
  linkedCharacterLabel: 'Linked character',
  linkedCharacterNone: 'None',
  linkedCharacterTag: 'About {name}',
  linkedLocationLabel: 'Location',
  linkedLocationNone: 'None',
  linkedLocationTag: 'At {name}',
  searchPlaceholder: 'Search notes…',
  searchNoResults: 'No notes match your search.',
  noteTypeLabel: 'Type',
  noteTypeNote: 'Note',
  noteTypeRuling: 'Ruling',
  rulingsOnlyFilter: 'Rulings only',
  saving: 'Saving…',
  saveNote: 'Save note',
  ...
  visibilityOwnerOnly: 'DM + author only',
  visibilityBadgeGmOnly: 'DM only',
  visibilityBadgeOwnerOnly: 'Private',
  toggleToGmOnly: 'Hide from players',
