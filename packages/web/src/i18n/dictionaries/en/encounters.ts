...
export const encounters = {
  ...
  battleMap: {
    ...
    panHint: 'Pan: middle-click drag, or hold Space and drag',
    undoMove: 'Undo move',
    undoMoveTitle: 'Move back to the previous position — costs movement like any other move if this token is mid-turn',
    snapToGrid: 'Snap to grid',
    snapToGridTitle: 'Toggle whether a dragged token snaps to whole cells while moving, or follows the pointer smoothly (the dropped cell is always whole either way)',
    previewPlayerView: 'Preview player view',
    previewingPlayerView: 'Previewing player view',
    previewPlayerViewTitle: 'Preview exactly what players currently see — a real server-filtered player payload (GM-only notes, elements, and tokens omitted), not just a client-side approximation',
    fogActiveHint: 'Showing what your party can currently see',
    refreshPreview: 'Refresh preview',
    refreshPreviewTitle: 'Request a fresh player-view snapshot from the server',
    previewSnapshotCaption: 'Snapshot as of {time} — click refresh to update',
    ...
    moving: 'Moving…',
    unplacedHint: 'Unplaced — tap a name, then tap the map or enter exact coordinates to place it:',
    coordinatesHint: 'Move {name} to an exact cell:',
    coordColumn: 'Column',
    coordRow: 'Row',
    goToCoordinates: 'Go',
  ...
  mapElements: {
    ...
    editingElements: 'Editing elements',
    palette: 'Palette',
    placeHint: 'Click the map to place a {type}',
    placeSegmentHintFirst: 'Click the {type}\'s start point',
    placeSegmentHintSecond: "Click the {type}'s end point",
    placePolygonHint: 'Click to add points, then Finish (min. 3 points)',
    ...
    visibilityGmOnly: 'DM only',
    visibilityRevealed: 'Revealed to players',
    visibilityOwnerOnly: 'DM + one player',
    owner: 'Visible to',
    ownerSelectPlaceholder: 'Select a player…',
    locked: 'Locked',
    saving: 'Saving…',
    save: 'Save',
    ...
    placementModes: {
      ...
      segment: 'Click start, then end',
      polygon: 'Click points, then Finish',
    },
    escapeCancelHint: 'Press Esc to cancel',
    fields: {
      doorState: 'State',
      brightRadiusFt: 'Bright radius (ft)',
      dimRadiusFt: 'Dim radius (ft)',
      color: 'Color',
      intensity: 'Intensity',
      costType: 'Terrain cost',
      noteBody: 'Note',
      widthFt: 'Width (ft)',
      heightFt: 'Height (ft)',
  ...
  pendingActions: {
    title: 'Actions awaiting approval ({count})',
    approve: 'Approve',
    reject: 'Reject',
    lastAttemptFailed: 'Last approval attempt failed: {error}',
    kind: {
      attack: 'Attack',
      cast: 'Cast a spell',
      shove: 'Shove',
    ...
    submitted: 'Submitted — waiting for your GM to approve.',
    approved: 'Approved and resolved.',
    rejected: 'Your GM rejected this action.',
  },
  addOverlay: {
