...
export const characters = {
  ...
  wizard: {
    ...
    identity: {
      ...
      quickCreate: 'Quick create (NPC-lite)',
      quickCreateHint: 'Skips race/background/class requirements below — good for a monster or a bit-part NPC.',
      race: 'Race',
      subrace: 'Subrace',
    ...
    abilityScores: {
      outOfRange: 'Every ability score must be between 1 and 30.',
    },
    derivedStats: {
    ...
    skills: {
      ...
      skillsHeading: 'Skill proficiencies',
      none: 'None',
