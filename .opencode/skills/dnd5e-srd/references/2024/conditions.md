...
**Automatic Critical Hits.** Any attack roll that hits you is a Critical Hit if the attacker is within 1.5 meters of you.
...
**Attacks Affected.** You have Disadvantage on attack rolls. An attack roll against you has Advantage if the attacker is within 1.5 meters of you. Otherwise, that attack roll has Disadvantage.
